...
class hack_rx_nbfm_v2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.xlate_filter_taps = xlate_filter_taps = firdes.low_pass(1, samp_rate, Largeur_filtre/2, 1700)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(60, (xlate_filter_taps), F_Fine, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_xlate_filter_taps(firdes.low_pass(1, self.samp_rate, self.Largeur_filtre/2, 1700))
...
def main(top_block_cls=hack_rx_nbfm_v2, options=None):
