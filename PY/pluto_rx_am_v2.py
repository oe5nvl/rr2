...
class pluto_rx_am_v2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(120, (xlate_filter_taps), F_Fine, samp_rate)
...
def main(top_block_cls=pluto_rx_am_v2, options=None):
