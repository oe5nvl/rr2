...
# Author: F1ATB - BUHART
# Description: RX SSB for HACK RF or RTL-SDR
# Generated: Thu Apr 22 16:14:50 2021
##################################################
...
class hack_rx_ssb_v2(gr.top_block):
...
def main(top_block_cls=hack_rx_ssb_v2, options=None):
