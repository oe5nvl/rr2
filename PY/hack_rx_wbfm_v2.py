...
# Author: F1ATB - BUHART
# Description: RX WBFM for HACK RF or RTL-SDR
# Generated: Thu Apr 22 16:15:39 2021
##################################################
...
class hack_rx_wbfm_v2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(15, (xlate_filter_taps), F_Fine, samp_rate)
...
def main(top_block_cls=hack_rx_wbfm_v2, options=None):
