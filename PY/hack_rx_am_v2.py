...
# Author: F1ATB - BUHART
# Description: RX AM for HACK RF or RTL-SDR
# Generated: Thu Apr 22 16:13:48 2021
##################################################
...
class hack_rx_am_v2(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "AM Receiver V2- F1ATB - MARCH 2021")

        ##################################################
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 2400e3
        self.Largeur_filtre = Largeur_filtre = 7500
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(240, (xlate_filter_taps), F_Fine, samp_rate)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_0, 0), (self.analog_simple_squelch_cc_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_xlate_filter_taps(firdes.low_pass(1, self.samp_rate, self.Largeur_filtre/2, 1500))
...
def main(top_block_cls=hack_rx_am_v2, options=None):
