...
# Author: F1ATB - BUHART
# Description: TX SSB Hack RF or RTL-SDR
# Generated: Tue Apr 20 19:42:04 2021
##################################################
...
class hack_tx_ssb_v2(gr.top_block):
...
def main(top_block_cls=hack_tx_ssb_v2, options=None):
